...
test "ParseTreeDepthFirstIterator" {
    ...
    var t1 = ParseTree.Data{ .Terminal = lex.Token.LParen };
    var t2 = ParseTree.Data{ .Terminal = lex.Token{ .Proposition = lex.PropositionVar{ .string = try std.testing.allocator.dupe(u8, "p") } } };
    defer std.testing.allocator.free(t2.Terminal.Proposition.string);
    var t3 = ParseTree.Data{ .Terminal = lex.Token{ .Operator = lex.WffOperator.Or } };
    var t4 = ParseTree.Data{ .Terminal = lex.Token{ .Proposition = lex.PropositionVar{ .string = try std.testing.allocator.dupe(u8, "q") } } };
    defer std.testing.allocator.free(t4.Terminal.Proposition.string);
    var t5 = ParseTree.Data{ .Terminal = lex.Token.RParen };
...
test "ParseTree: '(p v q)'" {
    ...
    var t1 = ParseTree.Node{ .parent = &root, .data = ParseTree.Data{ .Terminal = lex.Token.LParen } };
    var t2 = ParseTree.Node{ .parent = &(root_children.items[1]), .data = ParseTree.Data{ .Terminal = lex.Token{ .Proposition = lex.PropositionVar{ .string = try std.testing.allocator.dupe(u8, "p") } } } };
    defer std.testing.allocator.free(t2.data.Terminal.Proposition.string);
    var t3 = ParseTree.Node{ .parent = &root, .data = ParseTree.Data{ .Terminal = lex.Token{ .Operator = lex.WffOperator.Or } } };
    var t4 = ParseTree.Node{ .parent = &(root_children.items[3]), .data = ParseTree.Data{ .Terminal = lex.Token{ .Proposition = lex.PropositionVar{ .string = try std.testing.allocator.dupe(u8, "q") } } } };
    defer std.testing.allocator.free(t4.data.Terminal.Proposition.string);
    var t5 = ParseTree.Node{ .parent = &root, .data = ParseTree.Data{ .Terminal = lex.Token.RParen } };
